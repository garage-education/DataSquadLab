...
There are public, private, and intra (private w/o Internet access) subnets, and NAT Gateways created in each availability zone.
...
$ terraform apply
```
Ref: https://github.com/terraform-aws-modules/terraform-aws-vpc/blob/master/examples/complete/README.md
...
| <a name="module_vpc_endpoints_nocreate"></a> [vpc\_endpoints\_nocreate](#module\_vpc\_endpoints\_nocreate) | terraform-aws-modules/vpc/aws//modules/vpc-endpoints | n/a |
