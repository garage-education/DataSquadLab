...
output "dms_access_for_endpoint_iam_role_arn" {
  ...
  value       = module.dms_rds_migration.dms_access_for_endpoint_iam_role_arn
}

output "dms_access_for_endpoint_iam_role_id" {
  description = "Name of the IAM role"
  value       = module.dms_rds_migration.dms_access_for_endpoint_iam_role_id
}

output "dms_access_for_endpoint_iam_role_unique_id" {
  description = "Stable and unique string identifying the role"
  value       = module.dms_rds_migration.dms_access_for_endpoint_iam_role_unique_id
}

# DMS CloudWatch Logs
output "dms_cloudwatch_logs_iam_role_arn" {
  description = "Amazon Resource Name (ARN) specifying the role"
  value       = module.dms_rds_migration.dms_cloudwatch_logs_iam_role_arn
}

output "dms_cloudwatch_logs_iam_role_id" {
  description = "Name of the IAM role"
  value       = module.dms_rds_migration.dms_cloudwatch_logs_iam_role_id
}

output "dms_cloudwatch_logs_iam_role_unique_id" {
  description = "Stable and unique string identifying the role"
  value       = module.dms_rds_migration.dms_cloudwatch_logs_iam_role_unique_id
}

# DMS VPC
output "dms_vpc_iam_role_arn" {
  description = "Amazon Resource Name (ARN) specifying the role"
  value       = module.dms_rds_migration.dms_vpc_iam_role_arn
}

output "dms_vpc_iam_role_id" {
  description = "Name of the IAM role"
  value       = module.dms_rds_migration.dms_vpc_iam_role_id
}

output "dms_vpc_iam_role_unique_id" {
  description = "Stable and unique string identifying the role"
  value       = module.dms_rds_migration.dms_vpc_iam_role_unique_id
}
...
output "replication_subnet_group_id" {
  ...
  value       = module.dms_rds_migration.replication_subnet_group_id
}
...
output "endpoints" {
  ...
  value       = module.dms_rds_migration.endpoints
  sensitive   = true
}
...
output "s3_endpoints" {
  ...
  value       = module.dms_rds_migration.s3_endpoints
  sensitive   = true
}
...
output "replication_tasks" {
  ...
  value       = module.dms_rds_migration.replication_tasks
}
